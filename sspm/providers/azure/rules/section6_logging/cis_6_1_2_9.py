"""CIS Azure 6.1.2.9 – Ensure that Activity Log Alert Exists for Create or Update Public IP Address rule (Automated, L1)"""
...
_OPERATION = "microsoft.network/publicipaddresses/write"


@registry.rule
class CIS_6_1_2_9(AzureRule):
    metadata = RuleMetadata(
        id="azure-cis-6.1.2.9",
        ...
        description=(
            "An activity log alert must exist for the Create or Update Public IP Address "
            "operation to notify administrators of changes to public IP address resources."
        ),
        rationale=(
            "Public IP addresses expose Azure resources to the internet. Unauthorized creation "
            "or modification of public IPs could indicate an attacker establishing external "
            "access or exfiltration channels. Alerting enables rapid detection and response."
        ),
        ...
        remediation=(
            ...
            "Signal = Public IP Addresses Create or Update → Create action group → Create."
        ),
