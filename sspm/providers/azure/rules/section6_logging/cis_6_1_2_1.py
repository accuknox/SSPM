"""CIS Azure 6.1.2.1 – Ensure that Activity Log Alert exists for Create Policy Assignment (Automated, L1)"""
...
_OPERATION = "microsoft.authorization/policyassignments/write"


@registry.rule
class CIS_6_1_2_1(AzureRule):
    metadata = RuleMetadata(
        id="azure-cis-6.1.2.1",
        ...
        description=(
            "An activity log alert must exist for the Create or Update Policy Assignment "
            "operation to notify administrators of changes to policy assignments."
        ),
        rationale=(
            "Policy assignments define security controls across the subscription. Alerting on "
            "changes ensures that unauthorized or unexpected modifications are detected promptly "
        ...
        remediation=(
            ...
            "Signal = Policy Assignment Create or Update → Create action group → Create."
        ),
