...
class CIS_8_5_7(MS365Rule):
    ...
    async def check(self, data: CollectedData):
        ...
        return self._manual(
            message=(
                "Whether external participants can give or request control cannot "
                "be read via Microsoft Graph. Verify manually via Microsoft Teams "
                "PowerShell: Get-CsTeamsMeetingPolicy -Identity Global | fl "
                "AllowExternalParticipantGiveRequestControl — ensure it is False."
            )
        )
